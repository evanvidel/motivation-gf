package com.franco.motivation.data
...
class Mock {
    ...
    val all = MotivationCostants.FILTER.ALL
    private val happy = MotivationCostants.FILTER.HAPPY
    private val sunny = MotivationCostants.FILTER.SUNNY
